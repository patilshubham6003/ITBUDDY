...
@Component({
  selector: 'app-generatesenioritylisttable',
  templateUrl: './generatesenioritylisttable.component.html',
  styleUrls: ['./generatesenioritylisttable.component.css'],
})
export class GeneratesenioritylisttableComponent {
  ...
  add(): void {
    ...
    this.api.getSenioritylist(1, 1, 'SEQUENCE_NO', 'desc', '').subscribe(
      (data) => {
        if (data['count'] == 0) {
