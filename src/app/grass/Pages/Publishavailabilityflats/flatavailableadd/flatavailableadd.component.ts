...
@Component({
  selector: 'app-flatavailableadd',
  templateUrl: './flatavailableadd.component.html',
  styleUrls: ['./flatavailableadd.component.css'],
})
export class FlatavailableaddComponent {
  @Input()
  drawerVisible: boolean = false;
  @Input() drawerClose!: Function;
  @Input() data: any = flatavailability;
