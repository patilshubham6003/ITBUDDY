...
@Component({
  selector: 'app-objectionlistfor-inspector',
  templateUrl: './objectionlistfor-inspector.component.html',
  styleUrls: ['./objectionlistfor-inspector.component.css'],
  providers: [DatePipe],
})
export class ObjectionlistforInspectorComponent {
