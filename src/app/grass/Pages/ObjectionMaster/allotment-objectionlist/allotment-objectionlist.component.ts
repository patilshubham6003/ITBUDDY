...
import { AllotmentObjection } from 'src/app/grass/Models/AllotmentObjection';
// import { ALlotmentObjection } from 'src/app/grass/Models/AllotmentObjection';
import { APIServicesService } from 'src/app/grass/Services/APIService.service';

@Component({
  selector: 'app-allotment-objectionlist',
  templateUrl: './allotment-objectionlist.component.html',
  styleUrls: ['./allotment-objectionlist.component.css'],
})
export class AllotmentObjectionlistComponent {
  drawerVisible!: boolean;
  drawerTitle!: string;
  drawerData: AllotmentObjection = new AllotmentObjection();
  ...
  search(reset: boolean = false) {
    ...
    if (this.Status == 'P' && this.RESIDENCE_TYPE != '') {
      this.api
        .getObjectionMaster(
          this.pageIndex,
          this.pageSize,
          this.sortKey,
          sort,
          " AND STATUS = 'P' AND RESIDENCE_TYPE = " +
          this.RESIDENCE_TYPE +
    ...
    } else if (this.Status == 'A' && this.RESIDENCE_TYPE != '') {
      this.api
        .getObjectionMaster(
          this.pageIndex,
          this.pageSize,
          this.sortKey,
          sort,
          " AND STATUS = 'A' AND RESIDENCE_TYPE = " +
          this.RESIDENCE_TYPE +
          ' AND MONTH(REQUEST_DATETIME) = ' +
          this.MONTH +
          ' ' +
    ...
    } else if (this.Status == 'R' && this.RESIDENCE_TYPE != '') {
      this.api
        .getObjectionMaster(
          this.pageIndex,
          this.pageSize,
          this.sortKey,
          sort,
          " AND STATUS = 'R' AND RESIDENCE_TYPE = " +
          this.RESIDENCE_TYPE +
          ' AND MONTH(REQUEST_DATETIME) = ' +
          this.MONTH +
          ' ' +
    ...
    } else if (this.Status == 'ALL' && this.RESIDENCE_TYPE != '') {
      this.api
        .getObjectionMaster(
          this.pageIndex,
          this.pageSize,
      ...
      if (this.Status == 'P' && this.RESIDENCE_TYPE == '') {
        this.api
          .getObjectionMaster(
            ...
            this.sortKey,
            sort,
            " AND STATUS = 'P' AND MONTH(REQUEST_DATETIME) = " +
            this.MONTH +
            ' ' +
            ' AND YEAR(REQUEST_DATETIME) = ' +
            this.YEAR +
        ...
        this.api
          .getObjectionMaster(
            ...
            this.sortKey,
            sort,
            " AND STATUS = 'A' AND MONTH(REQUEST_DATETIME) = " +
            this.MONTH +
            ' ' +
            ' AND YEAR(REQUEST_DATETIME) = ' +
            this.YEAR +
        ...
        this.api
          .getObjectionMaster(
            ...
            this.sortKey,
            sort,
            " AND STATUS = 'R' AND MONTH(REQUEST_DATETIME) = " +
            this.MONTH +
            ' ' +
            ' AND YEAR(REQUEST_DATETIME) = ' +
            this.YEAR +
  ...
  objectiondata: AllotmentObjection = new AllotmentObjection();
  RejectRemark: boolean = false;

  edit(data: AllotmentObjection) {
  ...
  CancleRemark() {
    ...
    this.objectiondata = new AllotmentObjection();
  }
  ...
  getS1(link: string) {
    var a = '';
    if (this.view1 == 11) {
      a = this.api.retriveimgUrl + 'allotmentObjection/' + link;
    }
    if (this.view1 == 22) {
      a = this.api.retriveimgUrl + 'allotmentObjection/' + link;
    }
