...
@Component({
  selector: 'app-acceptance-summary-report',
  templateUrl: './acceptance-summary-report.component.html',
  styleUrls: ['./acceptance-summary-report.component.css'],
  providers: [DatePipe],
})
export class AcceptanceSummaryReportComponent implements OnInit {
  ...
  applyFilter() {
    ...
    for (var i = 0; i < this.ResidenceType.length; i++) {
      // this.separatedIds = this.ResidenceType[i];
    }
  ...
  convertInExcel() {
    ...
    if (this.excelData.length > 0) {
      for (var i = 0; i < this.excelData.length; i++) {
        ...
        obj1['Physical Acceptance '] = this.excelData[i]['PHYSICAL_COUNT'];
        obj1['Technical Acceptance'] = this.excelData[i]['TECHNICAL_COUNT'];
        obj1['Non-Acceptance '] = this.excelData[i]['NON_ACCEPTANCE_COUNT'];
