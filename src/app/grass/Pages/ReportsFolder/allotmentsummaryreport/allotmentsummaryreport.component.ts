...
@Component({
  selector: 'app-allotmentsummaryreport',
  templateUrl: './allotmentsummaryreport.component.html',
  styleUrls: ['./allotmentsummaryreport.component.css'],
  providers: [DatePipe],
})
export class AllotmentsummaryreportComponent {
  formTitle = 'Allotment Summary';
  ...
  // fileName = 'Allotment Summary Report';
