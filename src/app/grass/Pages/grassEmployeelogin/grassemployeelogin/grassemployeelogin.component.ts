...
@Component({
  selector: 'app-grassemployeelogin',
  templateUrl: './grassemployeelogin.component.html',
  styleUrls: ['./grassemployeelogin.component.css'],
})
export class GrassemployeeloginComponent {
  EMAIL_ID = '';
