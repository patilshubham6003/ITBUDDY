...
@Component({
  selector: 'app-residence-typewise-quarters-summary-report',
  templateUrl: './residence-typewise-quarters-summary-report.component.html',
  styleUrls: ['./residence-typewise-quarters-summary-report.component.css'],
  providers: [DatePipe],
})
export class ResidenceTypewiseQuartersSummaryReportComponent {
  formTitle = 'Residence Type Wise Quarters Summary';
  dataList: any[] = [];
  ...
  convertInExcel() {
    ...
    if (this.dataList11.length > 0) {
      for (var i = 0; i < this.dataList11.length; i++) {
        ...
        obj1['Area'] = this.dataList11[i]['AREA_NAME'] ? this.dataList11[i]['AREA_NAME'] : '_';
        obj1['Total Quarters'] = this.dataList11[i]['TOTAL'] ? this.dataList11[i]['TOTAL'] : '0';
        obj1['Vacant'] = this.dataList11[i]['AVAILABLE'] ? this.dataList11[i]['AVAILABLE'] : '0';
        obj1['Occupied'] = this.dataList11[i]['BOOKED'] ? this.dataList11[i]['BOOKED'] : '0';
        obj1['Under Maintenance'] = this.dataList11[i]['UNDER_MAINTAINENCE'] ? this.dataList11[i]['UNDER_MAINTAINENCE'] : '0';

        arry1.push(Object.assign({}, obj1));
        if (i == this.dataList11.length - 1) {
          this._exportService.exportExcel(
            arry1,
            'Residence Type Wise Quarters Summary Report ' +
