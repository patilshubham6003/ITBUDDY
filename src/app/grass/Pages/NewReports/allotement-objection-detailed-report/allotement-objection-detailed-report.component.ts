...
@Component({
  selector: 'app-allotement-objection-detailed-report',
  templateUrl: './allotement-objection-detailed-report.component.html',
  styleUrls: ['./allotement-objection-detailed-report.component.css'],
  providers: [DatePipe],
})
export class AllotementObjectionDetailedReportComponent {
  formTitle = ' Allotement Objection Detailed Report ';
  dataList: any[] = [];
      ...
      for (var i = 0; i < this.dataList11.length; i++) {
        ...
        if (i == this.dataList11.length - 1) {
          this._exportService.exportExcel(
            arry1,
            'Allotement Objection Detailed Report ' +
