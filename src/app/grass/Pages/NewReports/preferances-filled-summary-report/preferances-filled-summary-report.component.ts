...
@Component({
  selector: 'app-preferances-filled-summary-report',
  templateUrl: './preferances-filled-summary-report.component.html',
  styleUrls: ['./preferances-filled-summary-report.component.css'],
  providers: [DatePipe],
})
export class PreferancesFilledSummaryReportComponent {
  formTitle = ' Preferances Filled Summary ';
  dataList: any[] = [];
  ...
  convertInExcel() {
    ...
    if (this.dataList11.length > 0) {
      for (var i = 0; i < this.dataList11.length; i++) {
        ...
        obj1['Total Available'] = this.dataList11[i]['TOTAL'];
        obj1['Filled Preferances'] = this.dataList11[i]['FILLED_PREFERANCE'];
        obj1['Allocation'] = this.dataList11[i]['ALLOCATION'];
        obj1['Vacant'] =
          this.dataList11[i]['FILLED_PREFERANCE'] -
          this.dataList11[i]['ALLOCATION'];

        arry1.push(Object.assign({}, obj1));
        if (i == this.dataList11.length - 1) {
          this._exportService.exportExcel(
            arry1,
            'Preferances Filled Summary Report ' +
