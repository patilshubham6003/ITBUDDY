...
@Component({
  selector: 'app-quarters-allocation-summary-report',
  templateUrl: './quarters-allocation-summary-report.component.html',
  styleUrls: ['./quarters-allocation-summary-report.component.css'],
  providers: [DatePipe],
})
export class QuartersAllocationSummaryReportComponent {
  formTitle = 'Quarters Allocation Summary';
  dataList: any[] = [];
      ...
      for (var i = 0; i < this.dataList11.length; i++) {
        ...
        if (i == this.dataList11.length - 1) {
          this._exportService.exportExcel(
            arry1,
            'Quarters Allocation Summary Report ' +
