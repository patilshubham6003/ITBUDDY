...
@Component({
  selector: 'app-new-acceptance-summary-report',
  templateUrl: './new-acceptance-summary-report.component.html',
  styleUrls: ['./new-acceptance-summary-report.component.css'],
  providers: [DatePipe],
})
export class NewAcceptanceSummaryReportComponent {
  formTitle = ' Acceptance Summary ';
  dataList: any[] = [];
  ...
  columns: string[][] = [
    ...
    ['FILLED_ACCEPTANCE', 'FILLED_ACCEPTANCE'],
  ...
  convertInExcel() {
    ...
    if (this.dataList11.length > 0) {
      for (var i = 0; i < this.dataList11.length; i++) {
        ...
        obj1['Total Allocation'] = this.dataList11[i]['TOTAL_ALLOCATION'];
        obj1['Filled Acceptance'] = this.dataList11[i]['FILLED_ACCEPTANCE'];
        obj1['Non-Acceptance'] = this.dataList11[i]['NON_ACCEPTANCE'];
        obj1['Bard Due to No Action'] = this.dataList11[i]['BARD_DUE'];
