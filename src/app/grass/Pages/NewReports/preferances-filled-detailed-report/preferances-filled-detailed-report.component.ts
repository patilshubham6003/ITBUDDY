...
@Component({
  selector: 'app-preferances-filled-detailed-report',
  templateUrl: './preferances-filled-detailed-report.component.html',
  styleUrls: ['./preferances-filled-detailed-report.component.css'],
  providers: [DatePipe],
})
export class PreferancesFilledDetailedReportComponent {
  formTitle = ' Preferances Filled Detailed Report ';
  dataList: any[] = [];
      ...
      for (var i = 0; i < this.dataList11.length; i++) {
        ...
        if (i == this.dataList11.length - 1) {
          this._exportService.exportExcel(
            arry1,
            'Preferances Filled Detailed Report ' +
