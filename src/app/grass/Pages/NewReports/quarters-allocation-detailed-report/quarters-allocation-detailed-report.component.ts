...
@Component({
  selector: 'app-quarters-allocation-detailed-report',
  templateUrl: './quarters-allocation-detailed-report.component.html',
  styleUrls: ['./quarters-allocation-detailed-report.component.css'],
  providers: [DatePipe],
})
export class QuartersAllocationDetailedReportComponent {
  formTitle = ' Quarters Allocation Detailed Report ';
  dataList: any[] = [];
  ...
  columns: string[][] = [
    ...
    ['ALLOTMENT_DATE_TIME', 'ALLOTMENT_DATE_TIME'],
  ];
  ...
  convertInExcel() {
    ...
    if (this.dataList11.length > 0) {
      for (var i = 0; i < this.dataList11.length; i++) {
        ...
        obj1['Quarter Allotted Datetime'] =
          this.dataList11[i]['ALLOTMENT_DATE_TIME'];
        obj1['Acceptacnce/Non-Acceptance Datetime'] =
          this.dataList11[i]['ACCEPTANCE_NONACCEPTANCE_DATE'];
        obj1['Physical Reminder Datetime'] =
          this.dataList11[i]['PHYSICAL_REMINDER_DATE'];
        obj1['Physical Possession Datetime'] =
          this.dataList11[i]['PHYSICAL_POSSESSION_DATE'];
        obj1['Non-Acceptance Reason'] =
          this.dataList11[i]['NON_ACCEPTANCE_REMARK'];

        arry1.push(Object.assign({}, obj1));
        if (i == this.dataList11.length - 1) {
          this._exportService.exportExcel(
            arry1,
            'Quarters Allocation Detailed Report ' +
