...
@Component({
  selector: 'app-seniority-objection-summary-report',
  templateUrl: './seniority-objection-summary-report.component.html',
  styleUrls: ['./seniority-objection-summary-report.component.css'],
  providers: [DatePipe],
})
export class SeniorityObjectionSummaryReportComponent {
  formTitle = ' Seniority Objection Summary ';
  dataList: any[] = [];
      ...
      for (var i = 0; i < this.dataList11.length; i++) {
        ...
        if (i == this.dataList11.length - 1) {
          this._exportService.exportExcel(
            arry1,
            'Seniority Objection Summary Report ' +
