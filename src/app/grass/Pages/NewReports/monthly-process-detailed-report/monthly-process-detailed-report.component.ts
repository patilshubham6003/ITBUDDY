...
@Component({
  selector: 'app-monthly-process-detailed-report',
  templateUrl: './monthly-process-detailed-report.component.html',
  styleUrls: ['./monthly-process-detailed-report.component.css'],
  providers: [DatePipe],
})
export class MonthlyProcessDetailedReportComponent {
  formTitle = ' Monthly Process Detailed Report ';
  dataList: any[] = [];
      ...
      for (var i = 0; i < this.dataList11.length; i++) {
        ...
        if (i == this.dataList11.length - 1) {
          this._exportService.exportExcel(
            arry1,
            'Monthly Process Detailed Report ' +
