...
@Component({
  selector: 'app-headersteps',
  templateUrl: './headersteps.component.html',
  styleUrls: ['./headersteps.component.css'],
  providers: [DatePipe],
})
export class HeaderstepsComponent {
  ...
  //         }
  //         if (event == 5) {
  //           this.message.info('You Are Not Allowed For MTS', '');
  //         }
  //       }
  //     });
  // }
  ...
  ngOnInit() {
    ...
    //         // this.router.navigate(['/grass/Applicationcompo'], {
    //         //   replaceUrl: true,
    //         // });
    // this.router.navigate(['/grass/accomodation_allotment_process'], {
    //            replaceUrl: true,
    //          });
    //       }
    //     },
  ...
  add() {
    ...
    this.addnew = true
    this.api1.getprofiledata(0, 0, '', '', ' AND ID=' + sessionStorage.getItem('userId') + '').subscribe(
      (data) => {
