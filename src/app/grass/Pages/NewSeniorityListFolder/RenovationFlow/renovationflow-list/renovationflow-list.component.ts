...
@Component({
  selector: 'app-renovationflow-list',
  templateUrl: './renovationflow-list.component.html',
  styleUrls: ['./renovationflow-list.component.css'],
  providers: [DatePipe],
})
export class RenovationflowListComponent {
  constructor(
  ...
  mislistdata: any;
  searchdata: any = 'TREPHYA';
  searchdataMAIN: any = 'TREPHYA';
  ...
  ngOnInit() {
    ...
    this.selectFromMonth[0] = nextMonthDate;
  ...
  search(reset: boolean = false) {
    ...
    if (this.searchdata == 'TREPHYA') {
      ...
      this.api
        .getFlatTakenEmployeeFinalll(
          ...
          'ID',
          'desc',
          ' AND IS_APPLIEND_FOR_RENOVATION = 1 ' + this.filterQuery
        )
        .subscribe(
          (data) => {
            if (data.code == 200) {
      ...
      this.api
        .getFlatTakenEmployeeList111(
          ...
          'ID',
          'desc',
          " AND CURRENT_POSITION = 'PR' AND TAKEN_STATUS != 'R' AND IS_APPLIEND_FOR_RENOVATION = 1" +
            likeQuery
        )
        .subscribe(
          (data) => {
      ...
      this.api
        .getFlatTakenEmployeeFinalll(
          ...
          'ID',
          'desc',
          " AND CURRENT_POSITION = 'PP' AND IS_LIVING=1 AND TAKEN_STATUS != 'R' AND IS_APPLIEND_FOR_RENOVATION = 1" +
            likeQuery
        )
        .subscribe(
          (data) => {
      ...
      this.api
        .getFlatTakenEmployeeFinalll(
          ...
          'ID',
          'desc',
          " AND CURRENT_POSITION = 'HR' AND TAKEN_STATUS != 'R' AND IS_APPLIEND_FOR_RENOVATION = 1 " +
            likeQuery
        )
        .subscribe(
          (data) => {
    ...
    //       console.log(this.mislistdata, "sdfgh");
    //     },
    //     (err) => { }
    //   );
  }
