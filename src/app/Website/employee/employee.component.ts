...
import {
  ...
  ExamMaster,
  Family,
  OtherInfoOptionalMaster,
  Personalinfo,
  address,
  services,
} from 'src/app/Modal/profile';
...
export class EmployeeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.personalinformation.MOBILE_NO =
    ...
    if (this.addnew == true) {
      this.tabs = [
        ...
        },
        {
          ...
          disabled: this.empstatus[0].IS_PERSONAL_FILLED == 1 ? false : false,
        },
        {
          name: 'Family Details',
          disabled: this.empstatus[0].IS_PERSONAL_FILLED == 1 ? false : true,
  ...
  changecat(dd: any) {
    if (dd != null && dd != undefined) {
      let posttypedata = this.CategoryList.filter(
        (item) => item.ID == Number(dd)
      );
  ...
  changesubcat(dd: any) {
    if (dd != null && dd != undefined) {
      let posttypedata = this.subCategoryList.filter(
        (item) => item.ID == Number(dd)
      );
  ...
  getposttypeid(event: any) {
    if (event != null && event != undefined) {
      let sss = this.ranksss.filter((item) => item.ID == Number(event));
  ...
  officeranks(event: any) {
    ...
    if (event != undefined && event != null) {
      let posttypedata = this.Offices.filter(
  ...
  rankofentry(dd: any) {
    if (dd != null && dd != undefined) {
      let posttypedata = this.Ranks.filter((item) => item.ID == Number(dd));
  ...
  getimg() {
    ...
    if (this.personalinformation.PROFILE_PHOTO != null) {
      photo =
        this.imgurl + 'profileImages/' + this.personalinformation.PROFILE_PHOTO;
    }
    return photo;
  }
  ...
  savepersonal(): void {
    ...
    //   this.personalinformation.NAME == null ||
    ...
    // else
    if (
      this.personalinformation.MOBILE_NO == undefined ||
      this.personalinformation.MOBILE_NO == null ||
      this.personalinformation.MOBILE_NO.toString().trim() == ''
    ) {
      this.isOk = false;
    ...
    // else if (
    //   this.personalinformation.OFFICE_MAIL_ID == undefined ||
    //   this.personalinformation.OFFICE_MAIL_ID == null ||
    //   this.personalinformation.OFFICE_MAIL_ID.toString().trim() == ''
    // ) {
    //   this.isOk = false;
    //   this.message.error('Please Enter Personal Email ID', '');
    // } else if (
    //   !this.emailpattern.test(this.personalinformation.OFFICE_MAIL_ID)
    // ) {
    //   this.isOk = false;
    //   this.message.error('Please Enter Valid Personal Email ID', '');
    // } else if (
    //   this.personalinformation.OFFICE_MOBILE_NO == undefined ||
    //   this.personalinformation.OFFICE_MOBILE_NO == null ||
    //   this.personalinformation.OFFICE_MOBILE_NO.toString().trim() == ''
    // ) {
    //   this.isOk = false;
    ...
    // } else if (
    //   this.personalinformation.EMPLOYEE_CODE == undefined ||
    //   this.personalinformation.EMPLOYEE_CODE == null ||
    //   this.personalinformation.EMPLOYEE_CODE == ''
    // ) {
    //   this.isOk = false;
    //   this.message.error('Please Enter Employee Code', '');
    // } else if (
    //   this.personalinformation.GENDER == null ||
    //   this.personalinformation.GENDER == undefined ||
    ...
    // }
    // else if (
    //   this.personalinformation.EMAIL_ID == undefined ||
    //   this.personalinformation.EMAIL_ID == null ||
    //   this.personalinformation.EMAIL_ID.toString().trim() == ''
    // ) {
    //   this.isOk = false;
    ...
    // }
    // else if (
    //   this.personalinformation.MARRITAL_STATUS == null ||
    //   this.personalinformation.MARRITAL_STATUS == undefined ||
    //   this.personalinformation.MARRITAL_STATUS == ''
    // ) {
    //   this.isOk = false;
    //   this.message.error('Please Select Marital Status', '');
    // } else if (
    //   this.personalinformation.BLOOD_GROUP == null ||
    //   this.personalinformation.BLOOD_GROUP == undefined ||
    //   this.personalinformation.BLOOD_GROUP == ''
    // ) {
    //   this.isOk = false;
    //   this.message.error('Please Select Blood Group', '');
    // } else if (
    //   this.personalinformation.PAN_CARD == '' ||
    //   this.personalinformation.PAN_CARD == undefined ||
    //   this.personalinformation.PAN_CARD == null
    // ) {
    //   this.isOk = false;
    //   this.message.error('Please Enter PAN Card No.', '');
    // } else if (
    //   !this.panpattern.test(this.personalinformation.PAN_CARD.toUpperCase())
    // ) {
    //   this.isOk = false;
    //   this.message.error('Please Enter Valid PAN Card No.', '');
    // } else if (
    //   this.personalinformation.AADHAR_NO == '' ||
    //   this.personalinformation.AADHAR_NO == undefined ||
    //   this.personalinformation.AADHAR_NO == null
    // ) {
    //   this.isOk = false;
    //   this.message.error('Please Enter Aadhar No.', '');
    // } else if (
    //   this.personalinformation.MOTHER_TONGUE == '' ||
    //   this.personalinformation.MOTHER_TONGUE == undefined ||
    //   this.personalinformation.MOTHER_TONGUE == null
    // ) {
    //   this.isOk = false;
    ...
    // }
      ...
      this.personalinformation.PROFILE_PHOTO == null ||
      this.personalinformation.PROFILE_PHOTO == undefined ||
    ...
    if (this.isOk) {
      ...
      if (
        this.personalinformation.EMAIL_ID == undefined ||
        this.personalinformation.EMAIL_ID == ''
      ) {
        this.personalinformation.EMAIL_ID = null;
      }
      ...
      this.api1.updateprofile(this.personalinformation).subscribe(
        (successCode) => {
  ...
  onSelectedIndexChange(event: any) {
    ...
    if (event == 0) {
      ...
      this.searchPosting(true);
    }
    // else if (event == 5) {
    //   this.searchPromotion(true);
    // }
    else if (event == 5) {
            ...
            this.api
              ...
              .subscribe(
                (data) => {
                  ...
                  this.api
                    .getAllClass(0, 0, 'NAME', 'asc', ' AND STATUS=1')
                    .subscribe(
                      (data) => {
  ...
  saveservices(): void {
    var isOk = true;
    if (
      this.service.OFFICE_ID == null ||
      this.service.OFFICE_ID == undefined ||
      this.service.OFFICE_ID == 0
    ) {
      isOk = false;
      ...
      this.service.RANK_ID == null ||
      this.service.RANK_ID == undefined ||
      this.service.RANK_ID == 0
    ) {
      isOk = false;
      this.message.error(' Please Select Rank', '');
    } else if (
      this.service.ICARD_NO == null ||
      this.service.ICARD_NO == undefined ||
      this.service.ICARD_NO == '' ||
      this.service.ICARD_NO == ''
    ) {
      isOk = false;
      ...
      this.service.DOJ_PRESENT_POST == undefined ||
      this.service.DOJ_PRESENT_POST == ''
    ) {
      isOk = false;
      this.message.error(' Please Select Joining Date At Present Post', '');
    } else if (
      this.service.DOJ_PRESENT_RANK == null ||
      this.service.DOJ_PRESENT_RANK == undefined ||
      this.service.DOJ_PRESENT_RANK == ''
    ) {
      isOk = false;
      this.message.error(' Please Select Joining Date At Present Rank', '');
    } else if (
      this.service.DOE_GOV_SERVICE == null ||
      this.service.DOE_GOV_SERVICE == undefined ||
      this.service.DOE_GOV_SERVICE == ''
    ) {
      isOk = false;
      this.message.error(' Please Select Date Of Entry To Govt. Service', '');
    } else if (
      this.service.RANK_ID_GOV_SERVICE_NAME == null ||
      this.service.RANK_ID_GOV_SERVICE_NAME == undefined ||
      this.service.RANK_ID_GOV_SERVICE_NAME == ''
    ) {
      isOk = false;
      this.message.error(' Please Enter Rank of Entry For Govt. Service', '');
    } else if (
      this.service.DOJ_IT_STATE == null ||
      this.service.DOJ_IT_STATE == undefined ||
      this.service.DOJ_IT_STATE == ''
    ) {
      isOk = false;
      this.message.error(
        'Please Select Joining Date In IT Department Mumbai',
        ''
      );
    } else if (
      this.service.RANK_ID_IT_STATE_SERVICE == null ||
      this.service.RANK_ID_IT_STATE_SERVICE == undefined ||
      this.service.RANK_ID_IT_STATE_SERVICE == 0
    ) {
      isOk = false;
      this.message.error(
        'Please Select Rank of Entry For IT Department Mumbai',
        ''
      );
    }
    ...
    if (isOk) {
      ...
      if (this.service.ID) {
        this.api1.updateServiceDetails(this.service).subscribe(
          (successCode) => {
            if (successCode['code'] == '200') {
        ...
        this.api1.createServiceDetails(this.service).subscribe(
          (successCode) => {
            if (successCode['code'] == '200') {
              this.isSpinning = false;
              this.message.success(
  ...
  getallClass() {
    if (this.class.length == 0) {
      this.isSpinning = true;
      this.api.getAllClass(0, 0, 'NAME', 'asc', ' AND STATUS=1').subscribe(
        (forms) => {
  ...
  getallCity() {
    this.isSpinning = true;
    this.api
      .getAllCityMaster(0, 0, 'NAME', 'asc', ' AND STATUS=1 AND ID!= 266')
      .subscribe(
        (forms) => {
  ...
  getallState() {
    if (this.State.length == 0) {
      if (this.State.length == 0) {
        ...
        this.api
          .getAllStateMaster(0, 0, 'NAME', 'asc', ' AND STATUS = 1')
          .subscribe(
            (forms) => {
  ...
  sametemp() {
    if (this.address.IS_PERMANENT == true) {
      ...
      this.address.PERMANENT_MUMBAI_LOCAL_LINE =
        this.address.TEMP_MUMBAI_LOCAL_LINE;
  ...
  saveaddress() {
    ...
    if (
      this.address.TEMP_ADDRESS_LINE_1 == null ||
      this.address.TEMP_ADDRESS_LINE_1 == undefined ||
      this.address.TEMP_ADDRESS_LINE_1 == ''
    ) {
      this.isOk = false;
      this.message.error(
        ' Please Enter Address Line 1 For Current address',
        ''
      );
      this.isSpinning = false;
    } else if (
      this.address.TEMP_STATE_ID == null ||
      this.address.TEMP_STATE_ID == undefined ||
      this.address.TEMP_STATE_ID == 0
    ) {
      this.isOk = false;
      this.message.error(' Please Select State For Current address', '');
      this.isSpinning = false;
    } else if (
      this.address.TEMP_CITY_ID == null ||
      this.address.TEMP_CITY_ID == undefined ||
      this.address.TEMP_CITY_ID == 0
    ) {
      this.isOk = false;
      this.message.error(' Please Select Ciry For Current address', '');
      this.isSpinning = false;
    } else if (
      this.address.TEMP_PINCODE == null ||
      this.address.TEMP_PINCODE == undefined ||
      this.address.TEMP_PINCODE == 0
    ) {
      this.isOk = false;
      ...
      this.address['TEMP_ADDRESS_PROOF'] == null ||
      this.address['TEMP_ADDRESS_PROOF'] == undefined ||
      this.address['TEMP_ADDRESS_PROOF'] == ''
    ) {
      this.isOk = false;
      this.message.error(' Please Enter Pincode For Current address', '');
      this.isSpinning = false;
    ...
    if (this.isOk) {
      ...
      if (this.address.ID) {
        this.api1.updateAddressDetails(this.address).subscribe(
          (successCode) => {
            if (successCode['code'] == '200') {
              ...
              this.personalinformation.ADDRESS =
                this.address.TEMP_ADDRESS_LINE_1 +
                ',' +
                this.address.TEMP_ADDRESS_LINE_2 +
                ',' +
                this.address.TEMP_STATE_NAME +
                this.address.TEMP_STATE_NAME +
                ',' +
                this.address.TEMP_CITY_NAME +
                ',' +
                this.address.TEMP_PINCODE;
              this.api1.updateprofile(this.personalinformation).subscribe(
                (successCode) => {
                  if (successCode['code'] == '200') {
                    this.isSpinning = false;
        ...
        this.api1.createAddressDetails(this.address).subscribe(
          (successCode) => {
            if (successCode['code'] == '200') {
              this.isSpinning = false;
  ...
  getCityyy(event: any) {
    ...
    this.api
      .getAllCityMaster(0, 0, 'NAME', 'asc', filter + ' AND ID!= 266')
      .subscribe(
        (forms) => {
          this.City = forms['data'];
          this.isSpinning = false;
            ...
            if (data['data'].length > 0) {
              ...
              this.tabs = [
                ...
                },
                {
                  name: 'Address Details',
                  disabled:
                    this.empstatus[0].IS_PERSONAL_FILLED == 1 ? false : true,
                },
                {
                  name: 'Service Details',
                  disabled:
  ...
  @ViewChild('accountMasterPage', { static: false })
  accountMasterPagevar: NgForm;
  ...
  searchFamily(reset: boolean = false) {
    ...
    if (this.searchFamilyText != '') {
      ...
      this.columnFamily.forEach((column) => {
        likeQuery +=
          ' ' + column[0] + " like '%" + this.searchFamilyText + "%' OR";
      });
  ...
  //Optional Details
  otherInfoOptionalData: OtherInfoOptionalMaster =
    new OtherInfoOptionalMaster();
  isSpinningOtherInfoOptionalDetails: boolean = false;
  selectedLanguages: {
    ID: number;
    LANGUAGE_NAME: string;
    ACCESSBILITY: { label: string; value: string; checked?: boolean }[];
  }[] = [];
  ...
  onLanguageSelected(
    ...
    const existingLanguageIndex = this.selectedLanguages.findIndex(
      (item) => item.ID == languageId
    );
    if (existingLanguageIndex != -1) {
      this.selectedLanguages[existingLanguageIndex].ACCESSBILITY = checkboxes;
      this.selectedLanguages[existingLanguageIndex].LANGUAGE_NAME =
        languageName;
  ...
  onCheckboxSelected(
    languageId: number,
    checkboxValues: { label: string; value: string; checked?: boolean }[]
  ) {
    const existingLanguageIndex = this.selectedLanguages.findIndex(
      (item) => item.ID == languageId
    );
    if (existingLanguageIndex != -1) {
      this.selectedLanguages[existingLanguageIndex].ACCESSBILITY =
        checkboxValues;
    }
  }
        ...
        (data) => {
          if (data['code'] == 200) {
            if (data['data'].length > 0) {
              ...
              this.otherInfoOptionalData = Object.assign(
                {},
                tempOtherInfoOptionalData
              );
              if (this.otherInfoOptionalData.KNOWN_LANGUAGES) {
                const datass = JSON.parse(
                  this.otherInfoOptionalData.KNOWN_LANGUAGES
                );
                ...
                datass.forEach((languageData) => {
                  ...
                  switch (languageId) {
                    case 1:
                      ...
                      break;
                    case 2:
                      this.otherInfoOptionalData.KNOWN_LANGUAGES_2 =
                        languageName;
                      this.ACCESSBILITY2 = accessibility;
                      break;
                    case 3:
                      this.otherInfoOptionalData.KNOWN_LANGUAGES_3 =
                        languageName;
                      this.ACCESSBILITY3 = accessibility;
                      break;
                    case 4:
                      this.otherInfoOptionalData.KNOWN_LANGUAGES_4 =
                        languageName;
  ...
  saveOptionalDetails(): void {
    let isOK = true;
    if (isOK) {
      this.otherInfoOptionalData.KNOWN_LANGUAGES = JSON.stringify(
        this.selectedLanguages
      );
      ...
      if (this.otherInfoOptionalData.ID) {
        ...
        this.api1
          .updateEmployeeOtherInfoOptionalDetails(this.otherInfoOptionalData)
          .subscribe(
            (successCode) => {
              if (successCode['code'] == 200) {
                this.message.success('Other Details Updated Successfully', '');
        ...
        this.api1
          .createEmployeeOtherInfoOptionalDetails(this.otherInfoOptionalData)
          .subscribe(
            (successCode) => {
              if (successCode['code'] == 200) {
                this.message.success(
  ...
  onScrollEducation(e: any) {
    const activityItemEducation = document.getElementById(
      'activityItemEducation'
    );
  ...
  searchEducation(reset: boolean = false) {
    ...
    if (this.searchEducationText != '') {
      ...
      this.columnEducation.forEach((column) => {
        likeQuery +=
          ' ' + column[0] + " like '%" + this.searchEducationText + "%' OR";
      });
      likeQuery = likeQuery.substring(0, likeQuery.length - 2);
    }
    if (this.searchEducationText == '') {
    ...
    this.api
      .getEducation(
        this.pageEducationIndex,
        this.pageEducationSize,
        this.sortEducationKey,
        sort,
        likeQuery
      )
      .subscribe(
  ...
  examSearch(reset: boolean = false): void {
    ...
    if (this.examSearchText != '') {
      ...
      this.examColumns.forEach((column) => {
        likeQuery +=
          ' ' + column[0] + " like '%" + this.examSearchText + "%' OR";
      });
      likeQuery = likeQuery.substring(0, likeQuery.length - 2);
      likeQuery += ')';
    }
  ...
  columnPromotion: any[][] = [
    ...
    ['CONFIRMATION_DATE', 'To Date'],
    // ['PROMOTION_BASED_ON_NAME', 'Based On ?'],
  ];

  // drawerDataPromotion: PromotionDetails = new PromotionDetails();
  drawerVisiblePromotion = false;
  searchPromotionText = '';
  pagePromotionIndex = 1;
  pagePromotionSize = 10;
  sortPromotionKey = 'id';
  sortPromotionValue = 'desc';
  totalPromotionRecords = 0;
  dataPromotionList: any = [];
  loadingPromotionRecords = false;

  sortPromotion(params: NzTableQueryParams): void {
    this.loadingPromotionRecords = true;
    const { pageSize, pageIndex, sort } = params;
    const currentSort = sort.find((item) => item.value !== null);
    const sortField = (currentSort && currentSort.key) || 'ID';
    const sortOrder = (currentSort && currentSort.value) || 'desc';
    this.pagePromotionIndex = pageIndex;
    this.pagePromotionSize = pageSize;

    if (this.pagePromotionSize != pageSize) {
      this.pagePromotionIndex = 1;
      this.pagePromotionSize = pageSize;
    }

    if (this.sortPromotionKey != sortField) {
      this.pagePromotionIndex = 1;
      this.pagePromotionSize = pageSize;
    }

    this.sortPromotionKey = sortField;
    this.sortPromotionValue = sortOrder;
    this.searchPromotion(false);
  }
  searchLoding = true;
  searchPromotion(reset: boolean = false) {
    if (reset) {
      this.pagePromotionIndex = 1;
      this.sortPromotionKey = 'CONFIRMATION_DATE';
      this.sortPromotionValue = 'desc';
      this.dataPromotionList = [];
    }

    var sort: string;

    try {
      sort = this.sortPromotionValue.startsWith('a') ? 'asc' : 'desc';
    } catch (error) {
      sort = '';
    }
    ...
    if (this.searchPromotionText != '') {
      likeQuery = ' AND (';

      this.columnPromotion.forEach((column) => {
        likeQuery +=
          ' ' + column[0] + " like '%" + this.searchPromotionText + "%' OR";
      });

      likeQuery = likeQuery.substring(0, likeQuery.length - 2);
    }

    // likeQuery =likeQuery + 'AND EMPLOYEE_ID=' + sessionStorage.getItem('EMPLOYEE_ID');
    ...
    this.api
      .getAllPromotionDetailsMaster(
        ...
        this.pagePromotionSize,
        this.sortPromotionKey,
        sort,
        likeQuery
      )
      .subscribe(
        (data) => {
          if (data['code'] == 200 && data['data'].length > 0) {
            this.loadingPromotionRecords = false;
            this.totalPromotionRecords = data['count'];
            // this.dataPromotionList = data['data'];
            if (this.GLOBAL_TABLE_CARD == 'C') {
              this.dataPromotionList = [
                ...this.dataPromotionList,
                ...data['data'],
  ...
  // drawerDataPosting: PostingDetailsMaster = new PostingDetailsMaster();
  drawerVisiblePosting = false;
  searchPostingText = '';
  pagePostingIndex = 1;
  pagePostingSize = 10;
  sortPostingKey = 'id';
  sortPostingValue = 'desc';
  totalPostingRecords = 0;
  dataPostingList: any = [];
  loadingPostingRecords = false;

  sortPosting(params: NzTableQueryParams): void {
    this.loadingPostingRecords = true;
    const { pageSize, pageIndex, sort } = params;
    const currentSort = sort.find((item) => item.value !== null);
    const sortField = (currentSort && currentSort.key) || 'ID';
    const sortOrder = (currentSort && currentSort.value) || 'desc';
    this.pagePostingIndex = pageIndex;
    this.pagePostingSize = pageSize;

    if (this.pagePostingSize != pageSize) {
      this.pagePostingIndex = 1;
      this.pagePostingSize = pageSize;
    }

    if (this.sortPostingKey != sortField) {
      this.pagePostingIndex = 1;
      this.pagePostingSize = pageSize;
    }

    this.sortPostingKey = sortField;
    this.sortPostingValue = sortOrder;
    this.searchPosting(false);
  }

  loadmorePosting() {
    this.pagePostingIndex = this.pagePostingIndex + 1;
    this.searchPosting(false);
  }

  postinreqdata: any = [];

  searchPosting(reset: boolean = false) {
    if (reset) {
      this.pagePostingIndex = 1;
      this.sortPostingKey = 'FROM_DATE';
      this.sortPostingValue = 'desc';
      this.dataPostingList = [];
    }
    var sort: string;
    try {
      sort = this.sortPostingValue.startsWith('a') ? 'asc' : 'desc';
    } catch (error) {
      sort = '';
    }

    var likeQuery = '';
    if (this.searchPostingText != '') {
      likeQuery = ' AND (';

      this.columnPosting.forEach((column) => {
        likeQuery +=
          ' ' + column[0] + " like '%" + this.searchPostingText + "%' OR";
      });
    ...
    this.loadingPostingRecords = true;
    this.api
      .getAllPostingDetailsMaster(0, 0, this.sortPostingKey, sort, likeQuery)
      .subscribe(
        (data) => {
          if (data['code'] == 200 && data['data'].length > 0) {
            this.loadingPostingRecords = false;
            this.totalPostingRecords = data['count'];
            this.dataPostingList = data['data'];
            // if (this.GLOBAL_TABLE_CARD == 'C') {
            //   this.dataPostingList = [...this.dataPostingList, ...data['data']];
            // } else {
            ...
            this.api
              ...
              .subscribe(
                (forms) => {
                  var dataaaaa = forms['data'].filter(
                    (element: any) => element.APPROVAL_STATUS == 'P'
                  );

                  if (forms['code'] == 200 && forms['data'].length > 0) {
                    this.postinreqdata = forms['data'];
                    this.getallgenralreq();

                    this.dataPostingList = this.dataPostingList.map((item) => {
                      let match = dataaaaa.find(
                        (dataItem) => dataItem.POSTING_DETAILS_ID === item.ID
                      );
                      return match
                        ? { ...item, APPROVAL_STATUS: 'P' }
                        : { ...item, APPROVAL_STATUS: 'E' };
                    });
                  } else {
                    this.dataPostingList = data['data'];
                    this.postinreqdata = [];
  ...
  onScrollPromotion(e: any) {
    const activityItemPromotion = document.getElementById(
      'activityItemPromotion'
    );
    if (activityItemPromotion) {
      const scrollTop = activityItemPromotion.scrollTop;
      const offsetHeight = activityItemPromotion.offsetHeight;
      const scrollHeight = activityItemPromotion.scrollHeight;
      if (scrollTop + offsetHeight + 1 >= scrollHeight && !this.emitted) {
        this.emitted = true;
        this.onScrollingFinishedPromotion();
      } else if (scrollTop + offsetHeight + 1 < scrollHeight) {
        this.emitted = false;
      }
    }
  }
  onScrollingFinishedPromotion() {
    this.loadPromotionMore();
  }
  loadPromotionMore(): void {
    if (this.getNextItemsPromotion()) {
      this.categoriesSubject.next(this.dataPromotionList);
    }
  }
  getNextItemsPromotion(): boolean {
    if (this.dataPromotionList.length >= this.totalPromotionRecords) {
      return false;
    }
    this.pagePromotionIndex = this.pagePromotionIndex + 1;
    this.searchPromotion(false);
    return true;
  }

  onScrollPosting(e: any) {
    ...
    if (activityItem) {
      ...
      if (scrollTop + offsetHeight + 1 >= scrollHeight && !this.emitted) {
        this.emitted = true;
        this.onScrollingFinishedPosting();
      } else if (scrollTop + offsetHeight + 1 < scrollHeight) {
        this.emitted = false;
      }
    }
  }
  onScrollingFinishedPosting() {
    this.loadPotiongMore();
  }
  loadPotiongMore(): void {
    if (this.getNextItemsPosting()) {
      this.categoriesSubject.next(this.dataPostingList);
    }
  }
  getNextItemsPosting(): boolean {
    if (this.dataPostingList.length >= this.totalPostingRecords) {
      return false;
    }
    this.pagePostingIndex = this.pagePostingIndex + 1;
    this.searchPosting(false);
  ...
  drawerDataPosting: any;

  editPosting(data: any) {
    this.drawerTitle = 'Posting Details Change Request';
    this.drawerforwhat = 'P';
    this.drawerVisiblePosting = true;
    this.drawerDataPosting = data;
  }

  drawerPostingClose(): void {
    this.drawerVisiblePosting = false;
    this.searchPosting(true);
  }

  get closeCallbackPosting() {
    return this.drawerPostingClose.bind(this);
  }
  ...
  clearGradepayletterrrrrr() {
    this.address['PRE_ADDRESS_PROOF'] = null;
  }
  ...
  onFileSelectedTransfer2(event: any) {
    if (event.target.files[0].type == 'application/pdf') {
      ...
      if (this.gradepaydrawnletter != null) {
        ...
        if (
          this.address['TEMP_ADDRESS_PROOF'] != undefined &&
          this.address['TEMP_ADDRESS_PROOF'].trim() != ''
        ) {
          var arr = this.address['TEMP_ADDRESS_PROOF'].split('/');
          if (arr.length > 1) {
            url = arr[5];
          }
        }
      ...
      this.api
        ...
        .subscribe((successCode) => {
          if (successCode.code == '200') {
            this.address['TEMP_ADDRESS_PROOF'] = this.urllink3;
  ...
  gradepaydrawnletter1: any;
  urllink31: any = '';
  onFileSelectedTransfer222(event: any) {
    if (event.target.files[0].type == 'application/pdf') {
      this.isSpinning1 = true;
      this.gradepaydrawnletter1 = <File>event.target.files[0];

      if (this.gradepaydrawnletter1 != null) {
        var number = Math.floor(100000 + Math.random() * 900000);
        var fileExt = this.gradepaydrawnletter1.name.split('.').pop();
        var d = this.datepipe.transform(new Date(), 'yyyyMMdd');
        var url = '';
        url = d == null ? '' : d + number + '.' + fileExt;
        this.urllink31 = url;
        if (
          this.address['PRE_ADDRESS_PROOF'] != undefined &&
          this.address['PRE_ADDRESS_PROOF'].trim() != ''
        ) {
          var arr = this.address['PRE_ADDRESS_PROOF'].split('/');
          if (arr.length > 1) {
            url = arr[5];
          }
        }
      ...
      // this.data.GRADE_PAY_DRAWN_LETTER = this.urllink3;
      this.api
        .onUpload('ithrAddressProof', this.gradepaydrawnletter1, this.urllink31)
        .subscribe((successCode) => {
          if (successCode.code == '200') {
            this.address['PRE_ADDRESS_PROOF'] = this.urllink3;
      ...
      this.message.error('Please Select Only PDF File', '');
      this.gradepaydrawnletter1 = null;
      this.address['PRE_ADDRESS_PROOF'] = null;
    }
  }

  drawerforwhat: any;
  opendrawerforgenralreq() {
    this.drawerforwhat = 'G';
    this.drawerTitle = 'Other/general Details Change Request';
    this.drawerVisiblePosting = true;
  }
