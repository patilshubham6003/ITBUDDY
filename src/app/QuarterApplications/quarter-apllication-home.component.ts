...
@Component({
  selector: 'app-quarter-apllication-home',
  templateUrl: './quarter-apllication-home.component.html',
  styleUrls: ['./quarter-apllication-home.component.css'],
  providers: [DatePipe]
})
export class QuarterApllicationHomeComponent implements OnInit {
  isCollapsed = false;
  isLogedIn: any
