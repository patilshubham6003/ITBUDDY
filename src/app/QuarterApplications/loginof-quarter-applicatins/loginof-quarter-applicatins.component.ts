...
@Component({
  selector: 'app-loginof-quarter-applicatins',
  templateUrl: './loginof-quarter-applicatins.component.html',
  styleUrls: ['./loginof-quarter-applicatins.component.css']
})
export class LoginofQuarterApplicatinsComponent implements OnInit {
  constructor(
