...
@Component({
  selector: 'app-generatehodlist',
  templateUrl: './generatehodlist.component.html',
  styleUrls: ['./generatehodlist.component.css'],
})
export class GeneratehodlistComponent implements OnInit {
  drawerData2: any[] = [];
