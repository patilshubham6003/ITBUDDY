...
@Component({
  selector: 'app-addgeneratedelaycondonation',
  templateUrl: './addgeneratedelaycondonation.component.html',
  styleUrls: ['./addgeneratedelaycondonation.component.css'],
})
export class AddgeneratedelaycondonationComponent implements OnInit {
  @Input()
  ...
  addHospital(addNew: boolean, hospitalFormReset: NgForm) {
    this.hospitalData.DELAY_CONDOLATION_ID = this.delayCondolationID;
    this.isSpinning = false;
    this.isOk = true;
              ...
              if (successCode.code == '200') {
                ...
                this.api
                  .getHospitalMapping(
                    ...
                    '',
                    'desc',
                    ' AND DELAY_CONDOLATION_ID = ' + this.delayCondolationID
                  )
                  .subscribe(
                    (data) => {
                      if (data['code'] == 200) {
    ...
    if (this.current == 1) {
      ...
      this.api
        .getclaimMaster(
          ...
          '',
          '',
          ' AND ID =' + this.delayCondolationID,
          null,
          null,
          '',
          ''
          ...
          (data) => {
            if (data['code'] == 200) {
              if (data['data'].length == 0) {
                ...
                this.data = new DelayCondonationMaster();
                this.isSpinning = false;
              } else {
                this.data = data['data'][0];
    ...
    if (this.isOk) {
      ...
      );
      {
        if (this.data.ID) {
          ...
          //   EMP_ID: this.empID,
          //   CLAIM_ID: this.delayCondolationID,
          ...
          //   };
          // }
          // this.data['CLAIM_ID'] = this.delayCondolationID;
          this.api
            .updateDelayCondolation(this.data)
            .subscribe((successCode) => {
              if (successCode.code == '200') {
                ...
                //     ''
                //   );
                this.delayCondolationID = successCode.DELAY_CONDOLATION_ID;
          ...
          this.data.DELAY_CREATED_DATETIME = this.datepipe.transform(
            new Date(),
            'yyyy-MM-dd HH:mm:ss'
          );
          this.api
            .createDelayCondolation(this.data)
            .subscribe((successCode) => {
              if (successCode.code == '200') {
                this.message.success('Information Save Successfully...', '');
                this.delayCondolationID = successCode.DELAY_CONDOLATION_ID;
  ...
  claimSave(addNew: boolean): void {
    ...
    //   this.hospitalMapList[i]['DELAY_CONDOLATION_ID'] = undefined;
    // }
    // this.data.hospitalData = this.hospitalMapList;
    ...
    if (this.isOk) {
      this.data['DELAY_CONDOLATION_ID'] = this.delayCondolationID;
      this.isSpinning = true;
        ...
        if (this.data.ID) {
          ...
          this.api
            ...
            .subscribe((successCode) => {
              if (successCode.code == '200') {
                this.message.success('Information Save Successfully...', '');
                // this.delayCondolationID = successCode.EMPLOYEE
