...
@Component({
  selector: 'app-adddelaycondolation',
  templateUrl: './adddelaycondolation.component.html',
  styleUrls: ['./adddelaycondolation.component.css'],
})
export class AdddelaycondolationComponent implements OnInit {
  @Input()
