...
@Component({
  selector: 'app-delaycondolationlist',
  templateUrl: './delaycondolationlist.component.html',
  styleUrls: ['./delaycondolationlist.component.css'],
})
export class DelaycondolationlistComponent implements OnInit {
  drawerData2: any[] = [];
  ...
  search(reset: boolean = false) {
    ...
    this.api
      .getDelayCondolationMaster(
        ...
        this.sortKey,
        sort,
        extraFilterQuery + this.filterQuery + likeQuery
      )
      .subscribe(
        (data) => {
          if (data['code'] == 200) {
  ...
  edit(data: any): void {
    ...
    this.drawerData = Object.assign({}, data);
    this.delayCondolationID = '';
    this.delayCondolationID = this.drawerData.ID;
  ...
  delayOrderVisible: boolean = false;
  delayOrderTitle: string = '';
  queData: any = [];
  orderdata1: any = [];
  empID1;
  claimID1;
  ...
  dateBetweenDiff: any;
  sixMonthDate: any;
  orderDrawerData: any = new DelayCondonationMaster();
  delayOrderSignatureData: any = [];
  orderDrawer(data) {
    this.loadingRecords = true;
    this.delayOrderTitle = 'Delay Condonation Order';
    this.orderDrawerData = Object.assign({}, data);
    if (
      this.orderDrawerData.SIGNATURE_ID != undefined &&
      this.orderDrawerData.SIGNATURE_ID != null
    ) {
      this.api
        .getSignature(
          0,
          ...
          'ID',
          'desc',
          ' AND ID = ' + this.orderDrawerData.SIGNATURE_ID
        )
        .subscribe(
          (data) => {
            if (data['code'] == 200) {
    ...
    this.api
      .getHospitalMapping(
        ...
        '',
        '',
        ' AND DELAY_CONDOLATION_ID = ' + this.orderDrawerData.ID
      )
      .subscribe(
        (data) => {
          if (data['code'] == 200) {
            ...
            this.api
              .GetMedicalSignature(
                ...
                '',
                '',
                ' AND DELAY_ID = ' + this.orderDrawerData.ID
              )
              .subscribe(
                (data) => {
                  if (data['code'] == 200) {
                    if (data['data'].length > 0) {
                      this.delayOrderSignatureData = data['data'][0];
                    } else {
                      this.delayOrderSignatureData = new MedicalSignatureData();
                    }
                    this.loadingRecords = false;
                    this.delayOrderVisible = true;
                  } else {
    ...
    if (
      this.orderDrawerData.TREATMENT_END_DATE != null &&
      this.orderDrawerData.CLAIM_FILLED_DATE != null &&
      this.orderDrawerData.TREATMENT_END_DATE != undefined &&
      this.orderDrawerData.CLAIM_FILLED_DATE != undefined &&
      this.orderDrawerData.TREATMENT_END_DATE != '' &&
      this.orderDrawerData.CLAIM_FILLED_DATE != ''
    ) {
      this.diffdate = 0;
      var date = this.orderDrawerData.TREATMENT_END_DATE;
      var modifiedDate = new Date(date);
      var dateeeeeee = new Date(this.orderDrawerData.CLAIM_FILLED_DATE);

      modifiedDate.setMonth(modifiedDate.getMonth() + 6);
      const formattedDate = modifiedDate;
      const differenceMilliseconds =
        dateeeeeee.getTime() - formattedDate.getTime();
  ...
  get delayOrderSheetCloseCallback() {
    return this.delayOrderDrawerClose.bind(this);
  }
  delayOrderDrawerClose(): void {
    this.delayOrderVisible = false;
    this.search();
  }

  delayLetterVisible: boolean = false;
  delayLetterTitle: string = '';
  letterDrawerData: any = new DelayCondonationMaster();
  delayLetterSignatureData: any = [];
  letterDrawer(data) {
    this.loadingRecords = true;
    this.delayLetterTitle = 'Delay Condonation Letter ';
    this.letterDrawerData = Object.assign({}, data);
    if (this.letterDrawerData.LETTER_HEADER) {
      this.letterDrawerData.LETTER_HEADER = this.letterDrawerData.LETTER_HEADER;
    } else {
      this.letterDrawerData.LETTER_HEADER =
    ...
    if (
      this.letterDrawerData.SIGNATURE_ID != undefined &&
      this.letterDrawerData.SIGNATURE_ID != null
    ) {
      this.api
        .getSignature(
          0,
          ...
          'ID',
          'desc',
          ' AND ID = ' + this.letterDrawerData.SIGNATURE_ID
        )
        .subscribe(
          (data) => {
            if (data['code'] == 200) {
    ...
    this.api
      .getHospitalMapping(
        ...
        '',
        '',
        ' AND DELAY_CONDOLATION_ID = ' + this.letterDrawerData.ID
      )
      .subscribe(
        (data) => {
          if (data['code'] == 200) {
            ...
            this.api
              .GetMedicalSignature(
                ...
                '',
                '',
                ' AND DELAY_ID = ' + this.letterDrawerData.ID
              )
              .subscribe(
                (data) => {
                  if (data['code'] == 200) {
                    if (data['data'].length > 0) {
                      this.delayLetterSignatureData = data['data'][0];
                    } else {
    ...
    if (
      this.letterDrawerData.TREATMENT_END_DATE != null &&
      this.letterDrawerData.CLAIM_FILLED_DATE != null &&
      this.letterDrawerData.TREATMENT_END_DATE != undefined &&
      this.letterDrawerData.CLAIM_FILLED_DATE != undefined &&
      this.letterDrawerData.TREATMENT_END_DATE != '' &&
      this.letterDrawerData.CLAIM_FILLED_DATE != ''
    ) {
      this.diffdate = 0;
      var date = this.letterDrawerData.TREATMENT_END_DATE;
      var modifiedDate = new Date(date);
      var dateeeeeee = new Date(this.letterDrawerData.CLAIM_FILLED_DATE);
      modifiedDate.setMonth(modifiedDate.getMonth() + 6);
      const formattedDate = modifiedDate;
      const differenceMilliseconds =
        dateeeeeee.getTime() - formattedDate.getTime();
  ...
  get letterSheetCloseCallback() {
    return this.delayLetterDrawerClose.bind(this);
  }
  delayLetterDrawerClose(): void {
    this.delayLetterVisible = false;
    this.search();
  }
}
