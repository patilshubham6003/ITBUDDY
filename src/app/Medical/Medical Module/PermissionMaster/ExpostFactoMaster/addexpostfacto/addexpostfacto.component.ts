...
@Component({
  selector: 'app-addexpostfacto',
  templateUrl: './addexpostfacto.component.html',
  styleUrls: ['./addexpostfacto.component.css'],
})
export class AddexpostfactoComponent implements OnInit {
  @Input()
