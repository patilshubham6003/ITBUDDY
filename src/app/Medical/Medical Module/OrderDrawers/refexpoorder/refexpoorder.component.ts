...
@Component({
  selector: 'app-refexpoorder',
  templateUrl: './refexpoorder.component.html',
  styleUrls: ['./refexpoorder.component.css'],
})
export class RefexpoorderComponent implements OnInit {
  @Input()
  ...
  ngOnInit(): void {
    ...
    // ) {
    //   this.signature(this.orderdata.SIGNATURE_ID);
    // } else {
    // }
  }
