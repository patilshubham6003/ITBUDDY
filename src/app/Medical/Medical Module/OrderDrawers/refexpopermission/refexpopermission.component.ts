...
@Component({
  selector: 'app-refexpopermission',
  templateUrl: './refexpopermission.component.html',
  styleUrls: ['./refexpopermission.component.css'],
})
export class RefexpopermissionComponent implements OnInit {
  @Input()
