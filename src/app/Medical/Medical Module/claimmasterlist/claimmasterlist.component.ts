...
export class ClaimmasterlistComponent implements OnInit {
  ...
  search(reset: boolean = false) {
    ...
    var advancefilter = ' AND IS_APPLYING_FOR_ADVANCE = 0';
    this.loadingRecords = true;
    // this.api
    //   .getClaimMasterCount(
    //     this.pageIndex,
  ...
  edit(data: any): void {
    ...
    this.drawerData['EMPLOYEE_NAME'] = this.drawerData['EMPLOYEE_NAME'];
                              ...
                              .subscribe(
                                (data) => {
                                  if (data['code'] == 200) {
                                    if (data['data'].length > 0) {
                                      this.orderSignatureData = data['data'][0];
                                      if (data['data'][0]['NEW_ORDER_HEADER']) {
                                      ...
                                      if (
                                        data['data'][0][
                                          'SANCTION_ORDER_HEADER_EN'
                                        ]
                                      ) {
                                        this.orderSignatureData.SANCTION_ORDER_HEADER_EN =
                                          data['data'][0][
                                            'SANCTION_ORDER_HEADER_EN'
                                          ];
                                      } else {
                                        this.orderSignatureData.SANCTION_ORDER_HEADER_EN =
                                          '<div>Office of the&#160;</div><div>Pr. Chief Commissioner of Income tax&#160;</div><div>3rd floor, Aayakar Bhavan,&#160;</div><div>Maharshi Karve Road, Mumbai &#8211; 400 020</div><div><br></div>';
                                      }
                                      if (
                                        data['data'][0][
                                          'SANCTION_ORDER_HEADER_HN'
                                        ]
                                      ) {
                                        this.orderSignatureData.SANCTION_ORDER_HEADER_HN =
                                          data['data'][0][
                                            'SANCTION_ORDER_HEADER_HN'
                                          ];
                                      } else {
                                        this.orderSignatureData.SANCTION_ORDER_HEADER_HN =
                                          '<div>&#2325;&#2366;&#2352;&#2381;&#2351;&#2366;&#2354;&#2351;</div><div>&#2346;&#2381;&#2352;&#2343;&#2366;&#2344; &#2350;&#2369;&#2326;&#2381;&#2351; &#2310;&#2351;&#2325;&#2352; &#2310;&#2351;&#2369;&#2325;&#2381;&#2340;</div><div>&#160;&#2340;&#2368;&#2360;&#2352;&#2368; &#2350;&#2306;&#2332;&#2367;&#2354;, &#2310;&#2351;&#2325;&#2352; &#2349;&#2357;&#2344;,&#160;</div><div>&#160; &#2350;&#2361;&#2352;&#2381;&#2359;&#2367; &#2325;&#2352;&#2381;&#2357;&#2375; &#2350;&#2366;&#2352;&#2381;&#2327;, &#2350;&#2369;&#2306;&#2348;&#2312; - 400 020</div><div><br></div><div>&#2347;&#2379;&#2344;: 022-22017654</div>';
                                      }
                                    } else {
                                      this.orderSignatureData =
                ...
                (data) => {
                  if (data['code'] == 200) {
                    if (data['data'].length > 0) {
                      ...
                      this.gar23SignatureData = new MedicalSignatureData();
                    }
