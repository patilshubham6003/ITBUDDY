...
@Component({
  selector: 'app-date-wise-mode-wise-count',
  templateUrl: './date-wise-mode-wise-count.component.html',
  styleUrls: ['./date-wise-mode-wise-count.component.css'],
})
export class DateWiseModeWiseCountComponent implements OnInit {
  ...
  convertInExcel() {
    ...
    if (this.inspector.length > 0) {
      for (var i = 0; i < this.inspector.length; i++) {
        obj1['Travel Mode Name'] = this.inspector[i]['NAME'];
