...
@Component({
  selector: 'app-transfer-ddo-wise-claim-summary',
  templateUrl: './transfer-ddo-wise-claim-summary.component.html',
  styleUrls: ['./transfer-ddo-wise-claim-summary.component.css'],
})
export class TransferDdoWiseClaimSummaryComponent {
  formTitle = 'Transfer DDO Wise Claim Summary Report';
  userId: any;
  pageIndex = 1;
  pageSize = 10;
  totalRecords = 1;
      ...
      for (var i = 0; i < this.inspector.length; i++) {
        ...
        if (i == this.inspector.length - 1) {
          this._exportService.exportExcel(
            arry1,
            'Transfer DDO Wise Claim Summary Report' +
