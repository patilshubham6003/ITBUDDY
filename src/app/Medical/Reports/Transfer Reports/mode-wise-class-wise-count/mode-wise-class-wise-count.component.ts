...
@Component({
  selector: 'app-mode-wise-class-wise-count',
  templateUrl: './mode-wise-class-wise-count.component.html',
  styleUrls: ['./mode-wise-class-wise-count.component.css'],
})
export class ModeWiseClassWiseCountComponent implements OnInit {
  pageIndex = 1;
  pageSize = 10;
  totalRecords = 1;
  dataList: any = [];
  ...
  columns: string[][] = [
    ['travel_mode_master.NAME', 'Travel Mode Name'],
    ['travel_class_master.NAME', 'Travel Class Name'],
  ];
