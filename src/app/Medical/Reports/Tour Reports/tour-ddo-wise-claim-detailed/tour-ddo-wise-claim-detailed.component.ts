...
@Component({
  selector: 'app-tour-ddo-wise-claim-detailed',
  templateUrl: './tour-ddo-wise-claim-detailed.component.html',
  styleUrls: ['./tour-ddo-wise-claim-detailed.component.css'],
})
export class TourDdoWiseClaimDetailedComponent {
  formTitle = 'Tour DDO Wise Claim Detailed Report';
  userId: any;
  pageIndex = 1;
  pageSize = 10;
  totalRecords = 1;
  ...
  columns: string[][] = [
    ...
    ['HEADQUARTERS_NAME', 'Head Quater Address'],
  ...
  convertInExcel() {
    ...
    if (this.inspector.length > 0) {
      for (var i = 0; i < this.inspector.length; i++) {
        ...
        obj1['Head Quater Address'] = this.inspector[i]['HEADQUARTERS_NAME'];
        ...
        if (i == this.inspector.length - 1) {
          this._exportService.exportExcel(
            arry1,
            'Tour DDO Wise Claim Detailed Report' +
