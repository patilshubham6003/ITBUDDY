...
@Component({
  selector: 'app-inspector-wise-tour-summary-report',
  templateUrl: './inspector-wise-tour-summary-report.component.html',
  styleUrls: ['./inspector-wise-tour-summary-report.component.css'],
})
export class InspectorWiseTourSummaryReportComponent implements OnInit {
  ...
  columns: string[][] = [['user_master.NAME', 'Inspector Name']];
    ...
    for (var i = 0; i < this.inspector.length; i++) {
      ...
      if (i == this.inspector.length - 1) {
        this._exportService.exportExcel(
          arry1,
          'Inspector Wise Tour Summary Report' +
