...
@Component({
  selector: 'app-ltc-ddo-wise-claim-summary',
  templateUrl: './ltc-ddo-wise-claim-summary.component.html',
  styleUrls: ['./ltc-ddo-wise-claim-summary.component.css'],
})
export class LtcDdoWiseClaimSummaryComponent {
  formTitle = 'LTC DDO Wise Claim Summary Report';
  userId: any;
  pageIndex = 1;
  pageSize = 10;
  totalRecords = 1;
  ...
  applyFilter() {
    ...
    if (this.CLAIM_AT) {
      this.filterQuery += ' AND IS_ADMIN_LTC = ' + this.CLAIM_AT;
    }
