...
@Component({
  selector: 'app-date-wise-mode-wise-journey-countltc',
  templateUrl: './date-wise-mode-wise-journey-countltc.component.html',
  styleUrls: ['./date-wise-mode-wise-journey-countltc.component.css'],
})
export class DateWiseModeWiseJourneyCountltcComponent implements OnInit {
  ...
  columns: string[][] = [['TRAVEL_MODE_NAME', 'Travel Mode Name']];
  ...
  convertInExcel() {
    ...
    for (var i = 0; i < this.inspector.length; i++) {
      ...
      obj1['Journey Count'] = this.inspector[i]['JOURNEY_COUNT'];

      arry1.push(Object.assign({}, obj1));
      if (i == this.inspector.length - 1) {
        this._exportService.exportExcel(
          arry1,
          'Date Wise Mode Journey Count Report' +
