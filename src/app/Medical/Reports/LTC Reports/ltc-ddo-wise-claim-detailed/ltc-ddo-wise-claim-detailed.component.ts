...
@Component({
  selector: 'app-ltc-ddo-wise-claim-detailed',
  templateUrl: './ltc-ddo-wise-claim-detailed.component.html',
  styleUrls: ['./ltc-ddo-wise-claim-detailed.component.css'],
})
export class LtcDdoWiseClaimDetailedComponent {
  formTitle = 'LTC DDO Wise Claim Detailed Report';
  userId: any;
  pageIndex = 1;
  pageSize = 10;
  totalRecords = 1;
  ...
  search(reset: boolean = false, exportInExcel: boolean = false) {
    ...
    if (exportInExcel == false) {
      ...
      this.api
        .getAllltcMaster(0, 0, this.sortKey, sort, this.filterQuery + likeQuery)
        .subscribe(
          (data) => {
            if (data['code'] == 200) {
              this.exportLoading = false;
      ...
      for (var i = 0; i < this.inspector.length; i++) {
        ...
        if (i == this.inspector.length - 1) {
          this._exportService.exportExcel(
            arry1,
            'LTC DDO Wise Claim Detailed Report' +
