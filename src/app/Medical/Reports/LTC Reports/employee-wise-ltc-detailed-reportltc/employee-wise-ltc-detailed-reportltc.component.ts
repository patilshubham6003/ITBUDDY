...
@Component({
  selector: 'app-employee-wise-ltc-detailed-reportltc',
  templateUrl: './employee-wise-ltc-detailed-reportltc.component.html',
  styleUrls: ['./employee-wise-ltc-detailed-reportltc.component.css'],
})
export class EmployeeWiseLtcDetailedReportltcComponent implements OnInit {
  ...
  convertInExcel() {
    ...
    if (this.inspector.length > 0) {
      for (var i = 0; i < this.inspector.length; i++) {
        ...
        obj1['Block Year'] = this.inspector[i]['BLOCK_YEAR'];
