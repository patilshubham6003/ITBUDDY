...
@Component({
  selector: 'app-beneficiary-type-wise-detailed',
  templateUrl: './beneficiary-type-wise-detailed.component.html',
  styleUrls: ['./beneficiary-type-wise-detailed.component.css'],
})
export class BeneficiaryTypeWiseDetailedComponent implements OnInit {
    ...
    for (var i = 0; i < this.inspector.length; i++) {
      ...
      if (i == this.inspector.length - 1) {
        this._exportService.exportExcel(
          arry1,
          'Beneficiary Type Wise Detailed Report' +
