...
@Component({
  selector: 'app-inspector-wise-amount-stats-report',
  templateUrl: './inspector-wise-amount-stats-report.component.html',
  styleUrls: ['./inspector-wise-amount-stats-report.component.css'],
})
export class InspectorWiseAmountStatsReportComponent implements OnInit {
      ...
      for (var i = 0; i < this.inspector.length; i++) {
        ...
        if (i == this.inspector.length - 1) {
          this._exportService.exportExcel(
            arry1,
            'Inspector Wise Amount Stats Report' +
