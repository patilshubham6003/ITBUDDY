...
@Component({
  selector: 'app-hospitalwisedetailed',
  templateUrl: './hospitalwisedetailed.component.html',
  styleUrls: ['./hospitalwisedetailed.component.css'],
})
export class HospitalwisedetailedComponent implements OnInit {
  formTitle = 'Hospital Wise Detailed Report';
