...
@Component({
  selector: 'app-beneficiary-type-amount-stats',
  templateUrl: './beneficiary-type-amount-stats.component.html',
  styleUrls: ['./beneficiary-type-amount-stats.component.css'],
})
export class BeneficiaryTypeAmountStatsComponent implements OnInit {
  formTitle = 'Beneficiary Type Amount Stats Report';
      ...
      for (var i = 0; i < this.inspector.length; i++) {
        ...
        if (i == this.inspector.length - 1) {
          this._exportService.exportExcel(
            arry1,
            'Beneficiary Type Amount Stats Report' +
