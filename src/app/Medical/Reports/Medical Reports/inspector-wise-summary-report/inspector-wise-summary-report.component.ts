...
@Component({
  selector: 'app-inspector-wise-summary-report',
  templateUrl: './inspector-wise-summary-report.component.html',
  styleUrls: ['./inspector-wise-summary-report.component.css'],
})
export class InspectorWiseSummaryReportComponent implements OnInit {
  formTitle = 'Inspector Wise Summary Report';
  userId: any;
  pageIndex = 1;
  pageSize = 10;
  totalRecords = 1;
    ...
    if (exportInExcel == false) {
      ...
      this.api
        .inspectorWiseSummary(
          ...
          this.sortKey,
          sort,
          this.filterQuery + likeQuery + this.extraFilterQuery,
          this.START_DATE,
          this.END_DATE
        )
        .subscribe(
