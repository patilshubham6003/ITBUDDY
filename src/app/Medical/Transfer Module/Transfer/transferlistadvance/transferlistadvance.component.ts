...
@Component({
  selector: 'app-transferlistadvance',
  templateUrl: './transferlistadvance.component.html',
  styleUrls: ['./transferlistadvance.component.css'],
})
export class TransferlistadvanceComponent {
  drawerData2: any[] = [];
  ...
  pageSize2 = 10;
  formTitle = 'Manage Transfer Advance';
  pageIndex = 1;
  pageSize = 10;
  totalRecords = 1;
  dataList: any = [];
  ...
  search(reset: boolean = false) {
    ...
    if (!this.isAdmin) {
      ...
      this.userIdFilter =
        " AND TRANSFER_STATUS != 'P' AND IS_APPLYING_FOR_ADVANCE = 1 " +
        tempFilter;
    } else {
      this.userIdFilter = ' AND IS_APPLYING_FOR_ADVANCE = 1';
    }
  ...
  edit(data: any): void {
    ...
    //     this.drawerData.DDO_OF_THE_OFFICIAL_ID;
    // }
    this.drawerTitle = 'Edit Advance Transfer Details';
    this.api
          ...
          if (data['code'] == 200) {
            if (data['data'].length > 0) {
              ...
              this.alldocdata.TOTAL_ENT_AMOUNT =
                ...
                Number(this.alldocdata.GRANT_ONE_BASIC_PAY_AMOUNT) +
  ...
  //                                   this.nettotacountofbill = Math.round(
  ...
  AdvanceBillMap: TransferMapData = new TransferMapData();
  ManjuriAdeshSignatureMap: TransferMapData = new TransferMapData();
  DocumentSignatureMap: TransferMapData = new TransferMapData();
      ...
      .subscribe(
        (data) => {
          if (data['code'] == 200) {
            ...
            if (
              this.alldocdata.ADVANCED_CTG_REMARK == null ||
              this.alldocdata.ADVANCED_CTG_REMARK == undefined ||
              this.alldocdata.ADVANCED_CTG_REMARK == ''
            ) {
              this.alldocdata.ADVANCED_CTG_REMARK =
                '80% of ' +
                this.alldocdata.GRADE_PAY +
                ' = Rs ' +
                this.alldocdata.TRANSFER_GRANT_BASIC_PAY_TOTAL +
                '/-';
            } else {
            ...
            if (
              this.alldocdata.ADVANCED_PERSONAL_REMARK == null ||
              this.alldocdata.ADVANCED_PERSONAL_REMARK == undefined ||
              this.alldocdata.ADVANCED_PERSONAL_REMARK == ''
            ) {
              this.alldocdata.ADVANCED_PERSONAL_REMARK =
                '90% of ' +
                this.alldocdata.CHARGES_FOR_PERSONAL_EFFECTS_AMOUNT +
                ' = Rs' +
                this.totalpersonal90 +
                ' /-';
            } else {
            ...
            if (
              this.alldocdata.ADVANCED_PRIVATE_CONVEYANCE_REMARK == null ||
              this.alldocdata.ADVANCED_PRIVATE_CONVEYANCE_REMARK == undefined ||
              this.alldocdata.ADVANCED_PRIVATE_CONVEYANCE_REMARK == ''
            ) {
              this.alldocdata.ADVANCED_PRIVATE_CONVEYANCE_REMARK =
                '90% of ' +
                this.alldocdata.CHARGES_FOR_PRIVATE_CON_AMOUNT +
                ' = Rs' +
                this.totalprivate90 +
                ' /-';
            } else {
            ...
            if (
              this.alldocdata.ADVANCED_JOURNEY_REMARK == null ||
              this.alldocdata.ADVANCED_JOURNEY_REMARK == undefined ||
              this.alldocdata.ADVANCED_JOURNEY_REMARK == ''
            ) {
              this.alldocdata.ADVANCED_JOURNEY_REMARK =
                '90% of ' +
                this.alldocdata.TRA_ALLO_FARE_RS *
                  this.relationdataorder.length +
                ' /- = Rs';
              this.alldocdata.TRAVELLING_ALLOW_TOTAL + ' /-';
            } else {
              this.alldocdata.ADVANCED_JOURNEY_REMARK =
                this.alldocdata.ADVANCED_JOURNEY_REMARK;
            }
  ...
  approvaldraweropen(data: any): void {
    ...
    if (this.alldocdata.ID !== undefined && this.alldocdata.ID !== null) {
      this.api
        .GetTransferSignature(
          0,
          0,
