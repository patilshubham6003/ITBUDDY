...
@Component({
  selector: 'app-medical-employee-profile-new',
  templateUrl: './medical-employee-profile-new.component.html',
  styleUrls: ['./medical-employee-profile-new.component.css'],
  providers: [DatePipe],
})
export class MedicalEmployeeProfileNewComponent implements OnInit {
  ...
  savepersonal(): void {
    ...
    if (
      ...
      this.personalinformation.CATEGORY_ID == null ||
      this.personalinformation.CATEGORY_ID == undefined ||
      this.personalinformation.CATEGORY_ID == '' ||
      this.personalinformation.CATEGORY_ID == 0
    ) {
      this.isOk = false;
  ...
  officeranks1234(event: any) {
    this.api
      .getallDesignationForTransfer(
        ...
        'NAME',
        'asc',
        ' AND STATUS=1 AND CLASS_ID=' + event
      )
      .subscribe(
        (data) => {
          if (data['code'] == 200) {
  ...
  getallservicemastersdata() {
    ...
    if (
      ...
      this.api
        .getAllOfficeForTransfer(0, 0, 'NAME', 'asc', ' AND STATUS=1')
        .subscribe(
          (data) => {
