...
@Component({
  selector: 'app-medical-employee-family-new',
  templateUrl: './medical-employee-family-new.component.html',
  styleUrls: ['./medical-employee-family-new.component.css'],
  providers: [DatePipe]
})
export class MedicalEmployeeFamilyNewComponent implements OnInit {
