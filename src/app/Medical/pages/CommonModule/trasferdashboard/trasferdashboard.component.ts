...
@Component({
  selector: 'app-trasferdashboard',
  templateUrl: './trasferdashboard.component.html',
  styleUrls: ['./trasferdashboard.component.css'],
})
export class TrasferdashboardComponent implements OnInit {
