...
@Component({
  selector: 'app-ddo-massterlist',
  templateUrl: './ddo-massterlist.component.html',
  styleUrls: ['./ddo-massterlist.component.css'],
})
export class DdoMassterlistComponent {
  formTitle = ' DDO Master';
  ...
  columns: string[][] = [
    ...
    ['HEAD_OF_OFFICE_HN', 'Head of Office In Hindi'],
    ['LOCATION', 'Location'],
  ...
  edit(data: DDOMaster): void {
    this.drawerTitle = ' Update DDOMaster Information';
  ...
  search(reset: boolean = false) {
    ...
    this.api
      .getAllDDOs(this.pageIndex, this.pageSize, this.sortKey, sort, likeQuery)
      .subscribe(
        (data) => {
          if (data['code'] == 200) {
