...
@Component({
  selector: 'app-medical-employee-update',
  templateUrl: './medical-employee-update.component.html',
  styleUrls: ['./medical-employee-update.component.css'],
})
export class MedicalEmployeeUpdateComponent implements OnInit {
  ...
  save1(addNew: boolean, websitebannerPage: NgForm): void {
    ...
    } else if (this.data.SERVICE_TYPE == null || this.data.SERVICE_TYPE == '') {
      this.isOk = false;
    ...
    // else if (this.data.ROLE_ID == null || this.data.ROLE_ID == '') {
    //   this.isOk = false;
  ...
  SaveMobile() {
    ...
    if (this.MOBILE_NO == undefined || this.MOBILE_NO.toString().trim() == '') {
      this.message.error('Please Enter Mobile No. Or Email ID', '');
    }
