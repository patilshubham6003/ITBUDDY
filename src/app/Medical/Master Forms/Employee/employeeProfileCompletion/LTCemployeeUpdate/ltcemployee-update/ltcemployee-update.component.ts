...
@Component({
  selector: 'app-ltcemployee-update',
  templateUrl: './ltcemployee-update.component.html',
  styleUrls: ['./ltcemployee-update.component.css'],
})
export class LTCemployeeUpdateComponent {
