...
@Component({
  selector: 'app-transfer-employee-update',
  templateUrl: './transfer-employee-update.component.html',
  styleUrls: ['./transfer-employee-update.component.css'],
})
export class TransferEmployeeUpdateComponent {
      ...
      (res) => {
        ...
        if (res.type === HttpEventType.UploadProgress) {
          ...
          if (res.body['code'] == 200) {
            ...
            this.ImageUrl =
            this.imgurl + 'ProfileIMG/' + this.data.PROFILE_PHOTO;
          } else {
            this.isSpinning = false;
            this.progressBar5 = false;
          this.percent5 = 0;
