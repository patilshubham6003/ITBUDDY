...
export class SignaturemasterlistComponent {
  ...
  search(reset: boolean = false) {
    ...
    var ddoidd;
    if(Number(sessionStorage.getItem('ddoId'))!=undefined && Number(sessionStorage.getItem('ddoId'))!=null && sessionStorage.getItem('ddoId')!=''){
      ddoidd=' AND DDO_ID='+ Number(sessionStorage.getItem('ddoId'))
    }else {
      ddoidd=''
    }
    this.api
