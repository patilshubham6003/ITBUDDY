...
@Component({
  selector: 'app-user-profile-details-admin',
  templateUrl: './user-profile-details-admin.component.html',
  styleUrls: ['./user-profile-details-admin.component.css'],
  providers: [DatePipe],
})
export class UserProfileDetailsAdminComponent implements OnInit {
