...
@Component({
  selector: 'app-adminsignature-form',
  templateUrl: './adminsignature-form.component.html',
  styleUrls: ['./adminsignature-form.component.css'],
})
export class AdminsignatureFormComponent {
  @Input()
  drawerVisible: boolean = false;
  @Input() drawerClose: Function;
  @Input() data: adminsignature;
