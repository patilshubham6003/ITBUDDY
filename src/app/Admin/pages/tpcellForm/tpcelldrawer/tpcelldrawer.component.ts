...
@Component({
  selector: 'app-tpcelldrawer',
  templateUrl: './tpcelldrawer.component.html',
  styleUrls: ['./tpcelldrawer.component.css'],
})
export class TpcelldrawerComponent implements OnInit {
