...
@Component({
  selector: 'app-groupb-transfer-requests-list',
  templateUrl: './groupb-transfer-requests-list.component.html',
  styleUrls: ['./groupb-transfer-requests-list.component.css'],
  providers: [DatePipe],
})
export class GroupbTransferRequestsListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.value1 = this.datePipe.transform(startOfMonth, 'yyyy-MM-dd');
    this.value2 = this.datePipe.transform(endOfMonth, 'yyyy-MM-dd');
              ...
              if (this.dataList1.length > 0) {
                for (var i = 0; i < this.dataList1.length; i++) {
                  ...
                  obj1['Period Spent In Current Office'] = this.dataList1[i][
                    ...
                    : '-';
                  obj1['From Date'] =
                    this.dataList1[i]['FROM_DATE'] != null
                      ? this.datePipe.transform(
                          this.dataList1[i]['FROM_DATE'],
                          'dd/MMM/yyyy'
                        )
                      : this.dataList1[i]['FROM_DATE'];
                  obj1['To Date'] =
                    this.dataList1[i]['TO_DATE'] != null
                      ? this.datePipe.transform(
                          this.dataList1[i]['TO_DATE'],
                          'dd/MMM/yyyy'
                        )
                      : this.dataList1[i]['TO_DATE'];
