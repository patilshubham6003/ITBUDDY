...
@Component({
  selector: 'app-new-employees-details-dash',
  templateUrl: './new-employees-details-dash.component.html',
  styleUrls: ['./new-employees-details-dash.component.css'],
  providers: [DatePipe],
})
export class NewEmployeesDetailsDashComponent implements OnInit {
  formTitle = 'New Joinees Details Report';
  pageIndex = 1;
  pageSize = 10;
  totalRecords = 1;
  dataList: any = [];
